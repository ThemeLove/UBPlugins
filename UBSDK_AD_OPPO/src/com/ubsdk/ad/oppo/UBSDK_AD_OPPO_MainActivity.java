...
public class UBSDK_AD_OPPO_MainActivity extends Activity implements OnClickListener{
	private final String TAG=UBSDK_AD_OPPO_MainActivity.class.getSimpleName();
	...
	public void onClick(View arg0) {
        switch (arg0.getId()) {
            ...
            case R.id.but_isSupportADType:
            	...
            	ToastUtil.showToast(UBSDK_AD_OPPO_MainActivity.this, supportADTypeStr);
            ...
            case R.id.but_isSupportMethod:
            	...
            	ToastUtil.showToast(UBSDK_AD_OPPO_MainActivity.this, supportMethodStr);
            	break;
