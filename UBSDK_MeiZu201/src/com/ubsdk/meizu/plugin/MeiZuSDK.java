 ...
 * 2.最新的魅族单机sdk提供了登录和注销功能，该插件暂时不接入这些功能，调用即给出同步成功回调
 * 3.魅族sdk中AndoidManifest.xml中配置的Activity都用到了android:theme="@style/Theme.AppCompat"，所以要注意将appcompat-v7对应资源拷贝进去。
 * @author qingshanliao
 */
...
//		动态权限
		...
		UBSDK.getInstance().setUBActivityListener(new UBActivityListenerImpl(){
			...
			@Override
			public void onAttachedToWindow() {//注意UmbrellaActivity中只有接入了该生命周期方法才能执行到这里
...
//		类似于sdk初始化,demo中放到了onAttachedToWindow
