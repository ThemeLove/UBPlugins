...
public class UBSDK_OPPO_MainActivity extends Activity
{
    ...
    public final String TAG =UBSDK_OPPO_MainActivity.class.getSimpleName();
...
//                      TODO 去2次登录验签
        ...
        mStepToADBtn.setOnClickListener(new OnClickListener() {
			...
			@Override
			public void onClick(View v) {
				Intent intent = new Intent(UBSDK_OPPO_MainActivity.this,ADTestActivity.class);
